...
And that's it! You can deploy this project to Vercel, get a project URL, and plug it straight into your Discord application. Using Vercel as a host for my new bots has worked wonderfully so far.
