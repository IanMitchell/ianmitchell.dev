...
The information below will still work, but I would highly recommend checking
out [next-mdx-remote](https://github.com/hashicorp/next-mdx-remote) instead.
It's seen some iteration since I published this article, and I've since moved my
blog over to it.
...
_If you're impatient, the complete working example is at the <a href="#complete-picture">bottom of the page</a>!_
...
```jsx file=pages/blog/[post].js copy
