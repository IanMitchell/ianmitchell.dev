...
I liked the colors I had. The goal was to keep those in use, but just shuffle how I was using them. I also wanted to add a little more flair to the site - using apps like [Haikei](https://app.haikei.app) to generate SVG images for my footer helped a lot.
...
The last design iteration was very dark. I like having a dark mode, but I don't like having it be the only option - I know a lot of people struggle to read light text on dark backgrounds, so my top priority was to create a light mode / dark mode system. The dark theme isn't quite finished yet, but hopefully not too much longer.

## Readability / Typography

I'm still working on this, but I tried to make things just generally... nicer. I clean up some code by specifying font weights instead of using browser-computed styles (oops). Font updates, increasing sizes, padding, line-height, unit types... there was a lot to change.
