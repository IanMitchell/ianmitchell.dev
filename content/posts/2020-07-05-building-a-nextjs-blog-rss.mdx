...
Create a new `scripts/generate-rss.js` file with the following:
...
Finally, call the script during the build step by adding a call to it in `package.json`:
